...
> ⚠️ **旧版 App 内的「检查更新」会提示 3.3.10，但点「下载并安装」在最后一步必然失败**——这是签名限制、不是包坏了。请按上面的说法手动卸载重装。已经装了 3.3.5 及之后正式包的用户可以直接覆盖安装 3.3.10，无需卸载。

| 推荐给… | 包 | 下载 |
|---|---|---|
| 🟢 **想少装 App、App 内一键配对** | **OneKuku（独立激活）** | [OneIms-OneKuku-standalone-3.3.10.apk](https://github.com/asrtroh-netizen/OneIms/releases/download/v3.3.10/OneIms-OneKuku-standalone-3.3.10.apk) |
| 🔵 **已有 / 想用 Shizuku 轻壳** | **OneIms Lite（Shizuku）** | [OneIms-Lite-Shizuku-3.3.10.apk](https://github.com/asrtroh-netizen/OneIms/releases/download/v3.3.10/OneIms-Lite-Shizuku-3.3.10.apk) |

[📦 全部 Release 资产](https://github.com/asrtroh-netizen/OneIms/releases/tag/v3.3.10)
...
| 对外名称 | 包名 | 特权通道 | 最新版下载 |
|---|---|---|---|
| **OneIms · OneKuku** `3.3.10-onekuku` | `com.oneims.app` | 内嵌 OneBridge + 无线调试配对 | [OneIms-OneKuku-standalone-3.3.10.apk](https://github.com/asrtroh-netizen/OneIms/releases/download/v3.3.10/OneIms-OneKuku-standalone-3.3.10.apk) |
| **OneIms · OneIms Lite** `3.3.10-onelink` | `com.oneims.onelink` | 官方 Shizuku | [OneIms-Lite-Shizuku-3.3.10.apk](https://github.com/asrtroh-netizen/OneIms/releases/download/v3.3.10/OneIms-Lite-Shizuku-3.3.10.apk) |
